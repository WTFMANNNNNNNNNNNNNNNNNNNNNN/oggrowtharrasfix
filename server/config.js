module.exports = {
  ...
  servers: [
    ...
    },
    {
      ...
      region: "beta", // The region the server is on.
  ...
  // Bots
  bot_cap: 40, // Maximum number of bots that can be on the server. Set to 0 to disable bots.
  ...
  // Bosses
  bosses_spawn: true,
  boss_spawn_cooldown: 200, // The delay (in seconds) between boss spawns.
